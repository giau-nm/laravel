...
if (!defined('PAGGING_NUMBER_DEFAULT')) {
    define('PAGGING_NUMBER_DEFAULT', 100);
}
...
if (!defined('CONFIG_STYLE_NOTIFICATION_BASIC')) {
    define('CONFIG_STYLE_NOTIFICATION_BASIC', 0);
}
if (!defined('CONFIG_STYLE_NOTIFICATION_IMAGE')) {
    define('CONFIG_STYLE_NOTIFICATION_IMAGE', 1);
}
if (!defined('CONFIG_STYLE_NOTIFICATION_LIST')) {
    define('CONFIG_STYLE_NOTIFICATION_LIST', 2);
}
if (!defined('CONFIG_STYLE_NOTIFICATION_PROGRESS')) {
    define('CONFIG_STYLE_NOTIFICATION_PROGRESS', 3);
}
